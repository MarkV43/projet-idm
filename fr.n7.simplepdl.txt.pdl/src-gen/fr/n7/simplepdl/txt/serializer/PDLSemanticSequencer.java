...
public class PDLSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	 ...
	 *
	 * Constraint:
	 *     (work=[WorkDefinition|EString] amount=EInt resource=[Resource|EString])
	 * </pre>
	 */
	protected void sequence_ResourceUtilisation(ISerializationContext context, ResourceUtilisation semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, SimplepdlPackage.Literals.RESOURCE_UTILISATION__WORK) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SimplepdlPackage.Literals.RESOURCE_UTILISATION__WORK));
			if (transientValues.isValueTransient(semanticObject, SimplepdlPackage.Literals.RESOURCE_UTILISATION__AMOUNT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SimplepdlPackage.Literals.RESOURCE_UTILISATION__AMOUNT));
		...
		feeder.accept(grammarAccess.getResourceUtilisationAccess().getWorkWorkDefinitionEStringParserRuleCall_1_0_1(), semanticObject.eGet(SimplepdlPackage.Literals.RESOURCE_UTILISATION__WORK, false));
		feeder.accept(grammarAccess.getResourceUtilisationAccess().getAmountEIntParserRuleCall_3_0(), semanticObject.getAmount());
		feeder.accept(grammarAccess.getResourceUtilisationAccess().getResourceResourceEStringParserRuleCall_5_0_1(), semanticObject.eGet(SimplepdlPackage.Literals.RESOURCE_UTILISATION__RESOURCE, false));
		feeder.finish();
	}
	...
	protected void sequence_Resource(ISerializationContext context, Resource semanticObject) {
		if (errorAcceptor != null) {
			...
			if (transientValues.isValueTransient(semanticObject, SimplepdlPackage.Literals.RESOURCE__AMOUNT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SimplepdlPackage.Literals.RESOURCE__AMOUNT));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getResourceAccess().getNameEStringParserRuleCall_1_0(), semanticObject.getName());
		feeder.accept(grammarAccess.getResourceAccess().getAmountEIntParserRuleCall_3_0(), semanticObject.getAmount());
		feeder.finish();
	}
