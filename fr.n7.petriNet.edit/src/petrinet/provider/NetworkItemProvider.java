...
public class NetworkItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PetrinetPackage.Literals.NETWORK__ELEMENTS);
			childrenFeatures.add(PetrinetPackage.Literals.NETWORK__ARCS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PetrinetPackage.Literals.NETWORK__ELEMENTS,
		...
		newChildDescriptors.add
			(createChildParameter
				(PetrinetPackage.Literals.NETWORK__ARCS,
				 PetrinetFactory.eINSTANCE.createArc()));

		newChildDescriptors.add
			(createChildParameter
				(PetrinetPackage.Literals.NETWORK__ARCS,
				 PetrinetFactory.eINSTANCE.createReadArc()));
	}
