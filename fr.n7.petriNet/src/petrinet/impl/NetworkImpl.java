 ...
 * </p>
 * <ul>
 *   <li>{@link petrinet.impl.NetworkImpl#getElements <em>Elements</em>}</li>
 *   <li>{@link petrinet.impl.NetworkImpl#getArcs <em>Arcs</em>}</li>
...
public class NetworkImpl extends MinimalEObjectImpl.Container implements Network {
	...
	public EList<Element> getElements() {
		if (elements == null) {
			elements = new EObjectContainmentEList<Element>(Element.class, this, PetrinetPackage.NETWORK__ELEMENTS);
		}
		return elements;
	}
	...
	public EList<Arc> getArcs() {
		if (arcs == null) {
			arcs = new EObjectContainmentEList<Arc>(Arc.class, this, PetrinetPackage.NETWORK__ARCS);
		}
		return arcs;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PetrinetPackage.NETWORK__ELEMENTS:
				return ((InternalEList<?>)getElements()).basicRemove(otherEnd, msgs);
			case PetrinetPackage.NETWORK__ARCS:
