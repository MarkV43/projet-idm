...
public class WorkDefinitionItemProvider extends ProcessElementItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addResourcesUtilisedPropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the Resources Utilised feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addResourcesUtilisedPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_WorkDefinition_resourcesUtilised_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_WorkDefinition_resourcesUtilised_feature", "_UI_WorkDefinition_type"),
				 SimplepdlPackage.Literals.WORK_DEFINITION__RESOURCES_UTILISED,
				 true,
				 false,
				 true,
				 null,
