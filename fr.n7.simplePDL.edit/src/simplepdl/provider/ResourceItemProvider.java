...
public class ResourceItemProvider extends ProcessElementItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addUtilisationsPropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Resource_amount_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Resource_amount_feature", "_UI_Resource_type"),
				 SimplepdlPackage.Literals.RESOURCE__AMOUNT,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Utilisations feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addUtilisationsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Resource_utilisations_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Resource_utilisations_feature", "_UI_Resource_type"),
				 SimplepdlPackage.Literals.RESOURCE__UTILISATIONS,
				 true,
				 false,
				 true,
				 null,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Resource.class)) {
			case SimplepdlPackage.RESOURCE__AMOUNT:
