...
public class SimplepdlPackageImpl extends EPackageImpl implements SimplepdlPackage {
	 ...
	 * @generated
	 */
	public EReference getWorkDefinition_ResourcesUtilised() {
	 ...
	 * @generated
	 */
	public EAttribute getResourceUtilisation_Amount() {
	 ...
	 * @generated
	 */
	public EReference getResourceUtilisation_Work() {
	...
	public EReference getResourceUtilisation_Resource() {
		return (EReference)resourceUtilisationEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EAttribute getResource_Amount() {
	 ...
	 * @generated
	 */
	public EReference getResource_Utilisations() {
	...
	public void createPackageContents() {
		...
		createEReference(workDefinitionEClass, WORK_DEFINITION__RESOURCES_UTILISED);
		...
		createEAttribute(resourceUtilisationEClass, RESOURCE_UTILISATION__AMOUNT);
		createEReference(resourceUtilisationEClass, RESOURCE_UTILISATION__WORK);
		createEReference(resourceUtilisationEClass, RESOURCE_UTILISATION__RESOURCE);

		resourceEClass = createEClass(RESOURCE);
		createEAttribute(resourceEClass, RESOURCE__AMOUNT);
		createEReference(resourceEClass, RESOURCE__UTILISATIONS);
	...
	public void initializePackageContents() {
		...
		initEReference(getWorkDefinition_ResourcesUtilised(), this.getResourceUtilisation(), this.getResourceUtilisation_Work(), "resourcesUtilised", null, 0, -1, WorkDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getResourceUtilisation_Amount(), ecorePackage.getEInt(), "amount", null, 1, 1, ResourceUtilisation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getResourceUtilisation_Work(), this.getWorkDefinition(), this.getWorkDefinition_ResourcesUtilised(), "work", null, 1, 1, ResourceUtilisation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getResourceUtilisation_Resource(), this.getResource(), this.getResource_Utilisations(), "resource", null, 1, 1, ResourceUtilisation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(resourceEClass, Resource.class, "Resource", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getResource_Amount(), ecorePackage.getEInt(), "amount", null, 1, 1, Resource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getResource_Utilisations(), this.getResourceUtilisation(), this.getResourceUtilisation_Resource(), "utilisations", null, 0, -1, Resource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
