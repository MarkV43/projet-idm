 ...
 *   <li>{@link simplepdl.impl.WorkDefinitionImpl#getResourcesUtilised <em>Resources Utilised</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WorkDefinitionImpl extends ProcessElementImpl implements WorkDefinition {
	...
	/**
	 * The cached value of the '{@link #getResourcesUtilised() <em>Resources Utilised</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getResourcesUtilised()
	 * @generated
	 * @ordered
	 */
	protected EList<ResourceUtilisation> resourcesUtilised;
	 ...
	 * @generated
	 */
	public EList<ResourceUtilisation> getResourcesUtilised() {
		if (resourcesUtilised == null) {
			resourcesUtilised = new EObjectWithInverseResolvingEList<ResourceUtilisation>(ResourceUtilisation.class, this, SimplepdlPackage.WORK_DEFINITION__RESOURCES_UTILISED, SimplepdlPackage.RESOURCE_UTILISATION__WORK);
		}
		return resourcesUtilised;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case SimplepdlPackage.WORK_DEFINITION__RESOURCES_UTILISED:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getResourcesUtilised()).basicAdd(otherEnd, msgs);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case SimplepdlPackage.WORK_DEFINITION__RESOURCES_UTILISED:
				return ((InternalEList<?>)getResourcesUtilised()).basicRemove(otherEnd, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case SimplepdlPackage.WORK_DEFINITION__NAME:
				...
				return;
			case SimplepdlPackage.WORK_DEFINITION__RESOURCES_UTILISED:
				getResourcesUtilised().clear();
				getResourcesUtilised().addAll((Collection<? extends ResourceUtilisation>)newValue);
				return;
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case SimplepdlPackage.WORK_DEFINITION__RESOURCES_UTILISED:
				return resourcesUtilised != null && !resourcesUtilised.isEmpty();
		}
