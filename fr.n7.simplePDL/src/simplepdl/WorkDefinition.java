 ...
 *   <li>{@link simplepdl.WorkDefinition#getResourcesUtilised <em>Resources Utilised</em>}</li>
 * </ul>
 *
...
public interface WorkDefinition extends ProcessElement {
	...
	/**
	 * Returns the value of the '<em><b>Resources Utilised</b></em>' reference list.
	 * The list contents are of type {@link simplepdl.ResourceUtilisation}.
	 * It is bidirectional and its opposite is '{@link simplepdl.ResourceUtilisation#getWork <em>Work</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Resources Utilised</em>' reference list.
	 * @see simplepdl.SimplepdlPackage#getWorkDefinition_ResourcesUtilised()
	 * @see simplepdl.ResourceUtilisation#getWork
	 * @model opposite="work"
	 * @generated
	 */
	EList<ResourceUtilisation> getResourcesUtilised();
